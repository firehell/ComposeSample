...
@Composable
fun WeChatTopBar(title: String, onBack: (() -> Unit)? = null) {
    Box(
        Modifier
        ...
        Row(
            ...
            if (onBack != null) {
                Icon(
                    painterResource(com.zz.composesample.R.drawable.ic_back),
                    null,
                    Modifier
            ...
            Icon(
                painterResource(com.zz.composesample.R.drawable.ic_palette),
                "切换主题",
                Modifier
                    .clickable {
